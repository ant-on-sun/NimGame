...
public class AskNumberOfComputersTest {
    ConsoleView vmock;
    ...
    @Test
    public void askNumberOfComputersTest() throws Exception {
        PowerMockito.when(ReadInteger.readInt()).thenReturn(2);
        AskNumberOfComputers.askNumberOfComputers(vmock);
        PowerMockito.verifyStatic(ReadInteger.class);
        ReadInteger.readInt();
        Mockito.verify(vmock).setNumberOfComputers(2);
    }
